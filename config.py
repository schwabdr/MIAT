...
class configuration:
    def __init__(self):
        ...
        self.parser.add_argument('--lr', type=float, default=1e-1, metavar='LR',
                            help='learning rate')
        ...
        self.parser.add_argument('--epsilon', default=8/255,
                            help='perturbation')
        self.parser.add_argument('--num-steps', default=10,
                            help='perturb number of steps')
        self.parser.add_argument('--step-size', default=0.007,
        ...
        self.parser.add_argument('--model-dir', default='./checkpoint/wideresnet/standard_AT',
                            help='directory of model for saving checkpoint')
        self.parser.add_argument('--save-freq', '-s', default=2, type=int, metavar='N',
                            help='save frequency')
