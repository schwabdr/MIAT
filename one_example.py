...
img = read_image("data/cheese burger.jpg")
#print(img)
...
img_adv = pgd.projected_gradient_descent(model, batch, eps=eps, eps_iter=eps_iter, nb_iter=nb_iter, norm=np.inf, y=torch.tensor([281]), targeted=True)
