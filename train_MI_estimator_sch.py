...
# I read in the paper on DIM the output of the estimator is a 1D vector of size 64.
...
def main():
    ...
    name = 'resnet18-100' #input("Name of model to load: ")
    ...
    '''
    target_model = torch.nn.DataParallel(target_model,device_ids=[0]).cuda()
